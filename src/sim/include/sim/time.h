...
class Time {
  /// \brief A static zero time variable set to Time(0, 0).
public:
  static const Time Zero;

  /// \brief A static time variable set to a second: Time(1, 0).
public:
  static const Time Second;

  /// \brief A static time variable set to an hour: Time(3600, 0).
public:
...
public:
  Time(const Time &_time) noexcept;

  /// \brief Constructor
  /// \param[in] _tv Time to initialize to
public:
  Time(const struct timeval &_tv) noexcept;

  /// \brief Constructor
  /// \param[in] _tv Time to initialize to
public:
  Time(const struct timespec &_tv) noexcept;

  /// \brief Constructor
  /// \param[in] _sec Seconds
  /// \param[in] _nsec Nanoseconds
public:
  Time(int32_t _sec, int32_t _nsec) noexcept;

  /// \brief Constuctor
  /// \param[in] _time Time in double format sec.nsec
public:
  Time(double _time) noexcept;
...
public:
  static Time Sleep(const Time &_time);
...
public:
  ...
  /// \return nanoseconds
public:
  static inline double SecToNano(double _sec) { return _sec * 1e9; }

  /// \brief Convert milliseconds to nanoseconds
  /// \param[in] _ms milliseconds
  /// \return nanoseconds
public:
  static inline double MilToNano(double _ms) { return _ms * 1e6; }

  /// \brief Convert microseconds to nanoseconds
  /// \param _ms microseconds
  /// \return nanoseconds
public:
  static inline double MicToNano(double _ms) { return _ms * 1e3; }
